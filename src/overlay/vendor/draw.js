...
// `sticky` belongs here beside `callout`: both are drawn by dragging a box out,
// and renderShape() draws both from their bounding box. Left out, a sticky note
// placed with a single click carried ONE point, so its box was 0x0 and the note
// -- text and all -- rendered as nothing at all. From the outside that is not
// "the note was too small", it is "the sticky button does not work".
var TWO_POINT = { line: 1, arrow: 1, darrow: 1, rect: 1, rrect: 1, ellipse: 1, diamond: 1, triangle: 1, star: 1, callout: 1, sticky: 1 };
